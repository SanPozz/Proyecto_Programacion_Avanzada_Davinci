...
//
////            boolean flag = Usuario.signUp(nombreField.getText(), apellidoField.getText(), Integer.parseInt(edadField.getText()), correoField.getText(), passField.getText(), );
//            if (flag) {
//              datosValidos = true;
//            }
//
...
//      String[] opcionesAdmin = {"Mostrar Clientes", "Mostrar Empleados", "Registrar Empleado", "Eliminar Empleado por ID", "Mostrar Pedidos", "Mostrar Minerales", "Eliminar Minerales"};
//
