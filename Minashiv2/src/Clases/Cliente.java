    ...
    public Cliente(String nombre, String apellido, int edad, String correo, int rol) {
        ...
        public void emitirOrden() {
            try {
                ...
                PreparedStatement stmt = conn.prepareStatement("SELECT * FROM minerales WHERE tipo = ? AND pureza >= ?");
                ...
                if (seleccionado != null) {
                    ...
                    insertStmt.setDate(1, fecha);
                    insertStmt.setString(2, this.getNombre());
